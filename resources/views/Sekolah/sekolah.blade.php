                ...
                @endif
                  ...
                  <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <form action="{{url('/admin/sekolah/cari')}}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/sekolah/tambah')}}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="datatable" widht="100" cellspacing="0" >
                                    ...
                                    <tbody>
                                       @foreach ($sekolahs as $no => $item)
                                       <tr>
                                            <td style="text-align:center">{{ $sekolahs->firstitem()+$no }}</td>
                                            <td style="text-align:center">{{ $item->nama_sekolah}}</td>
                                            <td style="text-align:center">{{ $item->NPSN}}</td>
                                            <td style="text-align:center">{{ $item->jenjang_pendidikan}}</td>
                                            ...
                                            <td style="text-align:center">{{ $item->kabupaten}}</td>
                                            <td style="text-align:center">{{ $item->lintang}}</td>
                                            <td style="text-align:center">{{ $item->bujur}}</td>
                                            <td style="text-align:center">{{ $item->no_telpon}}</td>

                                            <td style="text-align:center">
                                                <form action="{{ url('/admin/sekolah/edit/'. $item->id)}}" method="get" class="d-inline" >
                                                    <button class="btn btn-info btn-circle btn-sm">
                                                            <i class="fas fa-fw fa-wrench"></i>
                                                    </button>
                                                </form>

                                                <form action="{{url('/admin/sekolah/delete/'.$item->id)}}" method="post" onsubmit="return confirm('Yakin Hapus Data?')" class="d-inline" >
                                                    @method('delete')
                                                    @csrf
