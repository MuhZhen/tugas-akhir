            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="col-lg-8 container">
                            <form action="{{url('/admin/sekolah/edit/simpan',[$editSekolah->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                <label>Nama Sekolah</label>
                                <input class="form-control" type="text" name="nama" value="{{ $editSekolah->nama_sekolah }}">
                                ...
                                <div class="form-group">
                                <label>NPSN</label>
                                <input class="form-control" type="text" name="npsn" value="{{ $editSekolah->NPSN }}">
                                ...
                                <option disable style="display:none" value="{{ $editSekolah->jenjang_pendidikan }}">{{ $editSekolah->jenjang_pendidikan }}</option>
                                ...
                                <option disable style="display:none" value="{{ $editSekolah->jenjang_pendidikan }}">{{ $editSekolah->status_sekolah }}</option>
                                <option value="">--Pilih Status Sekolah--</option>
                                ...
                                <div class="form-group">
                                <label>Alamat</label>
                                <input class="form-control" type="text" name="alamat" value="{{ $editSekolah->alamat }}">
                                ...
                                <input class="form-control" type="text" name="kecamatan" value="{{ $editSekolah->kecamatan }}">
                                ...
                                <input class="form-control" type="text" name="kabupaten" value="{{ $editSekolah->kabupaten }}">
                                ...
                                <div class="form-group">
                                <label>lintang</label>
                                <input class="form-control" type="text" id='lat' name="lintang" value="{{ $editSekolah->lintang }}">
                                ...
                                <div class="form-group">
                                <label>Bujur</label>
                                <input class="form-control" type="text" id='lng' name="bujur" value="{{ $editSekolah->bujur }}">
                                ...
                                <input class="form-control" type="text" name="ntelpon" value="{{ $editSekolah->no_telpon }}">
                                ...
                                <div>
                                              ...
                                              <a href="{{ url('admin/sekolah/edit/password/'. $editSekolah->id)}}" class="btn btn-secondary btn-sm btn-block">
