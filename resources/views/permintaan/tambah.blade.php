            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/permintaan/tambah/tabel')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Tambah bantuan</h1>
                        </div>

                        <div class="col-lg-8 container">
                            <form action="{{url('admin/permintaan/tambah')}}" method="post">
                                @csrf
                                <div class="form-group">
                                    <label>Nama Sekolah</label>
                                    <select name="sekolah_id" class="form-control" >
                                        <option value="{{$sekolahId->id}}">{{$sekolahId->nama_sekolah}}</option>
                                     
                                    </select>
                                    <label @error('sekolah_id') class="text-danger" @enderror> @error('sekolah_id')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <div class="form-group">
                                <label>Bantuan</label>
                                <textarea name="bantuan" class="form-control" rows="3" >Masukan Bantuan...</textarea>
