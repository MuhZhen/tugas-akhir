            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/permintaan')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">{{ $editBantuan->sekolah->nama_sekolah }}</h1>
                        </div>

                        <div class="col-lg-8 container">
                            <form action="{{url('/admin/permintaan/edit/simpan',[$editBantuan->id])}}" method="post">
                                @csrf
                                @method('PUT')

                                <div class="form-group">
                                <label>Bantuan</label>
                                <textarea name="bantuan" class="form-control" rows="3">{{ $editBantuan->bantuan }}</textarea>
                                ...
                                <select name="periode" class="form-control">
                                                      ...
                                                      <option hidden value="{{$editBantuan->periode}}"> {{$data_join->nama_periode}} </option>
                                                      @foreach($data_periode as $k)
                                                          <option value="{{$k->id}}"> {{$k->nama_periode}} </option>
                                                      @endforeach
                                </select>
                                <label @error('periode') class="text-danger" @enderror> @error('periode')
                                  {{$message}}
                                @enderror</label>
