            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="col-lg-8 container">
                            <form action="{{url('admin/permintaan/tambahSemua/simpan')}}" method="post">
                                @csrf
                                ...
                                <select name=periode class="custom-select" id="inputGroupSelect03">
                                    <option value="{{$dapatHasil->id}}">{{$dapatHasil->nama_periode}}</option>
