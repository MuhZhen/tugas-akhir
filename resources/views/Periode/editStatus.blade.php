            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/periode')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">{{ $dataPeriodeTabel->nama_periode }}</h1>
                        </div>

                        <div class="col-lg-8 container">
                            <form action="{{url('admin/periode/tambahperiode',[$dataPeriodeTabel->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <select name="status" class="form-control">
                                                      ...
                                                      <option hidden value="{{$dataPeriodeTabel->status}}"> {{$dataPeriodeTabel->status}} </option>
