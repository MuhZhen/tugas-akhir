      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Periode Permintaan Bantuan</h1>
          </div>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="datatable" widht="100" cellspacing="0" >
                                    ...
                                    @foreach ($dataPeriodeTabel as $item)
...
<!-- 
                                            <form action="{{ url('admin/periode/tampilEdit/'. $item->id)}}" method="get" class="d-inline" >
                                            ...
                                            <form action="{{url('admin/periode/delete/'.$item->id)}}" method="post" onsubmit="return confirm('Yakin Hapus Data?')" class="d-inline" >
                                                    @method('delete')
                                                    @csrf
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{url('admin/periode/tambahperiode')}}" method="post">
      @csrf
            <div class="form-group">
                                      <label>Nama Periode</label>
                                      <input name="nama" class="form-control" rows="3" placeholder="Masukan Nama Periode"></input>
            </div>

            <div class="form-group">
                                      <label>Tahun</label>
                                      <input name="tahun" class="form-control" rows="3" placeholder="Masukan Tahun Periode"></input>
...
<div class="modal fade" id="status" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{ url('admin/periode/tampilEdit/'. $item->id)}}" method="post">
      @csrf
      @method('PUT')
