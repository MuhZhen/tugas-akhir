        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Detail Proses SPK</h1>

                            <div class="d-flex justify-content-end">
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('admin/proses-alternatif')}}" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
              ...
              <table class="table table-bordered" id="datatable" widht="100" cellspacing="0">
                  <thead>
                     ...
                     <th class="text-center" style="vertical-align:middle">Nama</th>
                          @foreach($kriteria as $krit)
                              <th class="text-center" style="vertical-align:middle">{{$krit->nama}}</th>
                          @endforeach
                     </tr>
                  </thead>
                  ...
                  @foreach($alternatif as $data)
                      <tr>
                          <td>{{$data->bantuan->sekolah->nama_sekolah}}</td>
                    ...
                    <div class="card-body">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                ...
                                <table class="table table-bordered" id="datatable" widht="100" cellspacing="0">
                                    ...
                                    @foreach($alternatif as $data)
                                        <tr>
                                            <td style="vertical-align:middle">{{$data->bantuan->sekolah->nama_sekolah}}</td>
                                            @foreach($data->subkriteria as $crip)
                                                <td class="text-center" style="vertical-align:middle">{{$crip->bobot}}</td>
                                            @endforeach
                                        </tr>
                                    @endforeach
                                    @else
                                        ...
                                        <tr>
                                            ...
                                            @foreach($data->subkriteria as $crip)
                                                ...
                                                @endif
                                                    ...
                                                    <td class="text-center" style="vertical-align:middle">{{$normalisasi}}</td>
                                            @endforeach
                                            <?php $rangking[] = [
                                                'total' => $total,
