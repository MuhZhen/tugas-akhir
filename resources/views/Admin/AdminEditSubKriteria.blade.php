      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{url('/admin/atur/sub-kriteria')}}">Sub Kriteria</a>
            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/atur/sub-kriteria')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Edit Sub Kriteria</h1>
                        </div>

                        <div class="col-lg-8 container" >
                            <form action="{{url('/admin/atur/sub-kriteria/tambah/edit',[$EditTampilSubKriteria->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                        ...
                                        <option disable style="display:none" value="{{ $EditTampilSubKriteria->kriteria->id }}">{{ $EditTampilSubKriteria->kriteria->nama }}</option>
                                          
                                            <option value="">--Pilih Atribut--</option>
                                            @foreach ($tampilkriteria as $item)
                                            <option value="{{ $item->id }}">{{ $item->nama }}</option>
                                            @endforeach
                                        </select>
                                        <label @error('kriteria') class="text-danger" @enderror> 
                                            @error('kriteria')
                                              {{$message}}
                                            @enderror
                                        </label>
                                ...
                                <input class="form-control" type="text" name="subkriteria" value="{{ $EditTampilSubKriteria->nama }}">
                                <label @error('subkriteria') class="text-danger" @enderror> @error('subkriteria')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <input class="form-control" type="text" name="bobot" value="{{ $EditTampilSubKriteria->bobot }}">
