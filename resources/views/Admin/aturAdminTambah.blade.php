            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="col-lg-8 container">
                            <form action="{{url('admin/atur/tambah')}}" method="post">
                                @csrf
                                ...
                                <input class="form-control" type="text" name="nama_asli" value="{{old('nama_asli')}}">
                                ...
                                <input class="form-control" type="text" name="no_telpon" value="{{old('no_telpon')}}">
