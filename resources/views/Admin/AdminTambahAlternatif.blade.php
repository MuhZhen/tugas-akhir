                            ...
                            <form action="{{url('/admin/atur/alternatif/tambah')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bantuan_id" class="form-control" >
                                        ...
                                        @foreach ($tampilDataAlternatif as $item)
                                        <option value="{{ $item->id }}">{{ $item->sekolah->nama_sekolah }}</option>
                                        @endforeach
                                    </select>
                                    <label @error('bantuan_id') class="text-danger" @enderror> @error('bantuan_id')
                                  {{$message}}
                                @enderror</label>
                                </div>
