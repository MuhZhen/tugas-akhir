      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="{{url('/admin/atur/alternatif')}}">Alternatif</a>
          </div>
        </div>
      </li>
            ...
            <div class="card shadow mb-4">
                ...
                @endif
                  ...
                  <div class="card-body">
                        ...
                        <form action="{{url('/admin/atur/alternatif/cari')}}" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                                ...
                                <div class="col"></div>
                                        ...
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="" data-toggle="modal" data-target="#tambahModal" class="d-sm-inline-block btn btn-sm btn-primary shadow-sm">
                                              ...
                                              <a href="" data-toggle="modal" data-target="#hapusModal" class="d-sm-inline-block btn btn-sm btn-danger shadow-sm">
                                ...
                                <table class="table table-bordered" id="datatable" widht="100" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center">{{ $item->distribusi}}</td>
                                            ...
                                            <form action="{{ url('/admin/atur/alternatif/'. $item->id).'/editnilai'}}" method="get" class="d-inline" >
                                                ...
                                                <form action="{{ url('/admin/atur/alternatif/'. $item->id).'/edit'}}" method="get" class="d-inline" >
                                                    <button class="btn btn-info">
                                                    <i class="fas fa-fw fa-wrench"></i> Verifikasi
                                                    </button>
                                                </form>

                                                <form action="{{route('alternatif.hapus',['id' => $item->id])}}" method="post" onsubmit="return confirm('Yakin Hapus Data?')" class="d-inline" >
                                                    @csrf
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah Anda Ingin Menghapus Semua Alternatif?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>

        <form action="{{url('/admin/atur/alternatif/semua/hapus')}}" method="post">
                                @csrf
 ...
 <div class="modal fade" id="tambahModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Pilih Gelombang Bantuan

        <form action="{{url('/admin/atur/alternatif/tambah')}}" method="post">
        @csrf

        <div class="form-group">
        <select name="cari_periode" class="form-control" >
