            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Nilai Alternatif</h1>
                        </div>

                        <div class="col-lg-8 container">
                            <form action="{{route('nilai.simpan',['id' => Request::segment(4)])}}" method="post">
                                @csrf
                                @foreach ($master_kriteria as $krit)
                                <div class="form-group">
                                    <label for="{{$krit->id}}">{{$krit->nama}}</label>
                                    <select name="{{$krit->id}}" class="form-control">
                                        <option value="">-- Pilih {{$krit->nama}}  --</option>
