            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('/admin/atur/alternatif')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">{{ $EditTampilAlternatif->bantuan->sekolah->nama_sekolah }}</h1>
                        </div>

                        <div class="col-lg-8 container">
                            <form action="{{url('/admin/atur/alternatif/tambah/edit/'.$EditTampilAlternatif->id)}}" method="post">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group">
                                    ...
                                    <option disable style="display:none">{{ $EditTampilAlternatif->distribusi }}</option>
                                    <option value="">--Pilih Alternatif--</option>
                                        <option value="Belum Tersalurkan">Belum Tersalurkan</option>
                                        <option value="Tersalurkan">Tersalurkan</option>
                                    </select>
                                    <label @error('keterangan') class="text-danger" @enderror> @error('keterangan')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <option disable style="display:none">{{ $EditTampilAlternatif->verifikasi }}</option>
                                    <option value="">--Pilih Alternatif--</option>
