            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                                ...
                                <div class="col"></div>
                                        <div class="col d-sm-flex-inverse mb-4" >
                                          ...
                                          <h1 class="h3 mb-4 text-gray-800"></h1>
                                              <a href="{{url('admin/atur/admin')}}" class="button4 d-sm-inline-block btn btn-sm shadow-sm">
                        ...
                        <div class="col-lg-8 container">
                            <form action="{{url('admin/atur/simpan',[$pengguna->id])}}" method="post">
                                @csrf
                                @method('PUT')
                                <div class="form-group">
                                <label>Username</label>
                                <input class="form-control" type="text" name="username" value="{{$pengguna->username}}">
                                <label @error('username') class="text-danger" @enderror> @error('username')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <input class="form-control" type="text" name="nama_asli" value="{{$pengguna->nama_asli}}">
                                <label @error('nama_asli') class="text-danger" @enderror> @error('nama_asli')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <div class="form-group">
                                <label>Alamat</label>
                                <input class="form-control" type="text" name="alamat" value="{{$pengguna->alamat}}">
                                ...
                                <input class="form-control" type="text" name="no_telpon" value="{{$pengguna->no_telpon}}">
                                <label @error('no_telpon') class="text-danger" @enderror> @error('no_telpon')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <label @error('email') class="text-danger" @enderror> @error('email')
                                  {{$message}}
                                @enderror</label>
                                </div>
                                ...
                                <div>
                                  ...
                                  <a href="{{ url('admin/atur/edit/password/'. $pengguna->id)}}" class="btn btn-secondary btn-sm btn-block">
                                      <i class=" fa-sm text-black-50"></i> Ganti Password
                                  </a>  
                                ...
                                <select name="level_akses" class="form-control" value="{{$pengguna->level_akses}}"  >
                                <option hidden value="{{$pengguna->level_akses}}">{{$pengguna->level_akses}}</option>
                                <option value="SuperAdmin">SuperAdmin</option>
                                <option value="Relawan Verifikasi">Relawan Verifikasi</option>
                                <option value="Relawan Distribusi">Relawan Distribusi</option>
                                </select>
                                <label @error('level_akses') class="text-danger" @enderror> @error('level_akses')
                                  {{$message}}
                                @enderror</label>
                                </div>
