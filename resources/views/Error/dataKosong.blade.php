            ...
            <div class="card shadow mb-4">
                  ...
                  <div class="card-body">
                            ...
                            <div class="text-center">
                                    ...
                                    <br>
                                    <br>
                                    <p class="lead text-gray-800 mb-5">Error Proses SPK!</p>
                                    <p class="text-gray-500 mb-0">Silahkan isi data alternatif untuk menjalankan proses SPK</p>
                                    <a href="{{url('/admin/atur/alternatif')}}">← Back to Alternatif</a>
                                    </div>
                </div>
